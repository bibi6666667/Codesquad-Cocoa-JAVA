...
public class Model {
    ...
    void putAllBases(){ // 16개
        ...
        allBases.put("녹차","");
        allBases.put("요거트","");
        allBases.put("견과류","호두, 피스타치오, 아몬드");
        allBases.put("커피","자모카, 에스프레소");
        allBases.put("카라멜","");
        allBases.put("우유","크림, 연유");
    ...
    void putAllTopping(){ // 12개
        ...
        allToppings.put("크런치","");
        allToppings.put("쿠키","비스코티, 크래커");
        allToppings.put("초콜릿","");
        allToppings.put("초콜릿 칩","");
        allToppings.put("크런치 초콜릿","");
        allToppings.put("초코볼","프레첼볼, 다이제볼");
        allToppings.put("과자","초코파이, 킷캣, 후루트링, 미니바나나킥, 로투스, 죠리퐁, 프레첼, 첵스초코, 시리얼");
        allToppings.put("케이크","");
        allToppings.put("기타","마카롱, 고구마, 팥, 그래놀라, 감자볼");
